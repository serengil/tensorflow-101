...
**Face Recognition** [`VGG-Face Code`](https://github.com/serengil/tensorflow-101/blob/master/python/vgg-face.ipynb), [`VGG-Face Tutorial`](https://sefiks.com/2018/08/06/deep-face-recognition-with-keras/)
